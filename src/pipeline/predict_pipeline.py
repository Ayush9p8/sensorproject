...
class PredictionPipelineConfig:
    ...
    prediction_file_name: str = "prediction_fole.csv"
...
class PredictionPipeline:
    ...
    def get_predicted_dtaframe(self, input_dataframe_path: pd.DataFrame):
    ...
    def run_pipeline(self):
        try:
            ...
            self.get_predicted_dtaframe(input_csv_path)
